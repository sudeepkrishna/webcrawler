...
Build a web scraper that starts from the seed URL and returns the top 10 most expensive books found on the site.
...
4. Scrape book title, price, availability and product URL
